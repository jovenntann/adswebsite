(function($) {
  ...
  $(document).ready(function() {
    ...
    function initialize() {
      var map;
      var panorama;
      var var_latitude = 13.498010; // Google Map Latitude
      var var_longitude = 120.8995776; // Google Map Longitude
      var pin = '/static/public/images/icons/pin.png';

      //Map pin-window details
      var title = "Amihan Del Sol - Click to see";
      var hotel_name = "Amihan Del Sol";
      var hotel_address = "Lorem ipsum dolor, 25, Amihan Del Sol";
